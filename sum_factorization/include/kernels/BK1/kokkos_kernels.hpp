...
template <typename T>
std::vector<T> Kokkos_BwdTransHexKernel_QP_1D(const unsigned int nq0, const unsigned int nq1, const unsigned int nq2,
...
template <typename T>
std::vector<T> Kokkos_BwdTransHexKernel_QP_1D_SimpleMap(const unsigned int nq0, const unsigned int nq1, const unsigned int nq2,
    const T *__restrict__ basis0, const T *__restrict__ basis1, const T *__restrict__ basis2,
    const T* __restrict__ JxW, const T* __restrict__ in, T* __restrict__ out,
    const unsigned int numThreads, const unsigned int threadsPerBlock, const unsigned int nelmt, const unsigned int ntests)
    {   
...
template <typename T>
std::vector<T> Kokkos_BwdTransHexKernel_QP_2D_BLOCKS_pq(const unsigned int nq0, const unsigned int nq1, const unsigned int nq2,
    const T *__restrict__ basis0, const T *__restrict__ basis1, const T *__restrict__ basis2,
    const T* __restrict__ JxW, const T* __restrict__ in, T* __restrict__ out,
    const unsigned int numThreads, const unsigned int threadsPerBlock, const unsigned int nelmt, const unsigned int ntests)
    {   
...
template <typename T>
std::vector<T> Kokkos_BwdTransHexKernel_QP_2D_BLOCKS_pq_SimpleMap(const unsigned int nq0, const unsigned int nq1, const unsigned int nq2,
    const T *__restrict__ basis0, const T *__restrict__ basis1, const T *__restrict__ basis2,
    const T* __restrict__ JxW, const T* __restrict__ in, T* __restrict__ out,
    const unsigned int numThreads, const unsigned int threadsPerBlock, const unsigned int nelmt, const unsigned int ntests)
    {   
