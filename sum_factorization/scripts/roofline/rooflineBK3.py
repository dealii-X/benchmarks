...
def AchievedPerformance(nq0, nq1, nq2, nelmt, numBlocks, byte, dt):
    ...
    #Copy to Shmem
    globalRW += numBlocks * (nq0 * nm0 + nq1 * nm1 + nq2 * nm2 + nq0 * nq0 + nq1 * nq1 + nq2 * nq2)
    sharedRW += numBlocks * (nq0 * nm0 + nq1 * nm1 + nq2 * nm2 + nq0 * nq0 + nq1 * nq1 + nq2 * nq2)
